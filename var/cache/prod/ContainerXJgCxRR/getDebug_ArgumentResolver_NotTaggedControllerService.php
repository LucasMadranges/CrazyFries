 ...
 */
class getDebug_ArgumentResolver_NotTaggedControllerService extends App_KernelProdDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a = ($container->privates['.service_locator.OApOMGB'] ?? $container->load('get_ServiceLocator_OApOMGBService'));
