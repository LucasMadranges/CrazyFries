 ...
 */
class getDebug_Security_Voter_Security_Access_ExpressionVoterService extends App_KernelProdDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a = ($container->privates['security.authorization_checker'] ?? $container->load('getSecurity_AuthorizationCheckerService'));
